...
def criar_dados_padrao():
    ...
    if not usuario_existe:
        ...
        # Gera os IDs primários (idUsuario e idMundo) para relacioamentos a seguir
        bd.session.flush()
        ...
        estoque_usuario = EstoqueModel(
            idUsuario=usuario_padrao.idUsuario,
            idItem=item_pocao.idItem,
            qtd=3
        )
        ...
        print("✅ Usuário, Mundo, Exercícios, Estoque e Progresso criados com sucesso!")
